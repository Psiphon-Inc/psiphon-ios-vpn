...
NotifierMessage const NotifierApplicationParametersUpdated = PSIPHON_VPN_GROUP @".AppParamsUpdated";
...
- (instancetype)init {
    ...
    AddDarwinNotifyObserver(center, (__bridge const void *)self, (__bridge CFStringRef)NotifierApplicationParametersUpdated);
