...
extension Date {
    ...
    public enum SecondsFractionPrecision: Int32 {
        case zero = 0
        case three = 3
        case six = 6
        case nine = 9
    ...
    public static func parse(rfc3339Date: String) -> Date? {
        var ts = timestamp_t()
...
extension JSONDecoder {
    ...
    public static func makeRfc3339Decoder() -> JSONDecoder {
...
extension JSONEncoder {
    ...
    public static func makeRfc3339Encoder(
