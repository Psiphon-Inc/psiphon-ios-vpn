...
extension UserStrings {
    ...
    static func privacyPolicyHTMLText_v2021_09_09(languageCode: String) -> String {
        ...
        let privacy_information_collected_websites_head = NSLocalizedString("privacy-information-collected-websites-head", tableName: nil, bundle: Bundle.main,
                                                                            ...
                                                                            comment: "Sub-heading on the Privacy Policy page above the info about what user information is collected by the Psiphon websites")
        ...
        let privacy_information_collected_client_ads_head = NSLocalizedString("privacy-information-collected-client-ads-head", tableName: nil, bundle: Bundle.main,
                                                                              ...
                                                                              comment: "Sub-heading on the Privacy Policy page above the info about what user information is collected by the ads shown in the Psiphon client software")
        ...
        let privacy_information_collected_vpndata_whydoespsiphonneed_para_1_item_3 = NSLocalizedString("privacy-information-collected-vpndata-whydoespsiphonneed-para-1-item-3", tableName: nil, bundle: Bundle.main,
                                                                                                       value: "Determine the nature of major censorship events: Sites and services often get blocked suddenly and without warning, which can lead to huge variations in regional usage of Psiphon. For example, we had up to 20x surges in usage within a day when <a href=\"https://psiphon.ca/en/blog/brazil-whatsapp-2015.html\" target=\"_blank\">Brazil blocked WhatsApp</a> or <a href=\"https://blog-en.psiphon.ca/2016/11/social-media-and-internet-ban-in-turkey.html\" target=\"_blank\">Turkey blocked social media</a>.",
                                                                                                       comment: "Bullet list text under 'What does Psiphon do with User Activity and Aggregated Data?' subsection of the 'User Activity and VPN Data' section of the Privacy page.")
        ...
        let faq_information_collected_question = NSLocalizedString("faq-information-collected-question", tableName: nil, bundle: Bundle.main,
                                                                   value: "What user information does Psiphon collect?",
                                                                   comment: "Heading for a section in our privacy policy.")
        ...
        return """
            <h2>\(faq_information_collected_question)</h2>
        <!-- User VPN Data -->
