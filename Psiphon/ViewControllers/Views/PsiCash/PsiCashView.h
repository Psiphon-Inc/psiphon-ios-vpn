...
@property (strong, readonly, nonatomic) PsiCashRewardedVideoButton *rewardedVideoButton;
+ (void)animateBalanceChangeOf:(NSNumber*)delta withPsiCashView:(PsiCashView*)psiCashView inParentView:(UIView*)parentView;
@end
