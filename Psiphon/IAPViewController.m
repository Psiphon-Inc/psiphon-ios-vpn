...
- (void)viewDidLoad {
    ...
    [[AppDelegate.sharedAppDelegate.subscriptionStatus
      deliverOnMainThread]
    ...
    [self.refreshControl addTarget:self action:@selector(startProductRequest) forControlEvents:UIControlEventValueChanged];
...
- (UIView *)createNoProductsView {
    ...
    [refreshButton addTarget:self
                      action:@selector(startProductRequest)
...
- (void)buyButtonPressed:(UISegmentedControl *)sender {
    ...
    [SwiftAppDelegate.instance buyProduct:product];
}
